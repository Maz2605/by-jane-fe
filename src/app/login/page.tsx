    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-20 flex justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md border border-gray-100">
          <h1 className="text-2xl font-bold text-center mb-6 text-gray-800">Đăng nhập</h1>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            Chưa có tài khoản? <Link href="/register" className="text-[#FF5E4D] font-medium hover:underline">Đăng ký ngay</Link>
          </div>
        </div>
      </div>
      <Footer />
