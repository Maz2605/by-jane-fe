...
import { ArrowLeft, Save, ImagePlus, Trash, Loader2, Eye, X, User, Clock, ChevronLeft, Tag, Maximize2, Minimize2 } from "lucide-react";
                                ...
                                <div className="text-sm text-muted-foreground bg-gray-50 p-4 rounded-lg">
                                    <div className="flex justify-between py-1">
                                        ...
                                        <span className="font-medium text-gray-900">
                                            {newsItem && new Date(newsItem.createdAt).toLocaleDateString("vi-VN")}
                                        </span>
                                    </div>
                                    <div className="flex justify-between py-1">
                                        <span>Cập nhật lần cuối:</span>
                                        <span className="font-medium text-gray-900">
                                            {newsItem && new Date(newsItem.updatedAt).toLocaleDateString("vi-VN")}
                                        </span>
                                    </div>
                                </div>
                            </div>
